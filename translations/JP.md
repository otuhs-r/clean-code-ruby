...
Clean Code のコンセプトを Ruby に適合させたものです。

これは [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript) に触発されました。

*Note: ここに挙げている例の多くは JavaScript から移植してきました。そのため、Ruby っぽくないものがあるかもしれません。気軽に Issue を投げて指摘してください。すぐに修正します。また、 Pull Request もいつでも歓迎です！*
